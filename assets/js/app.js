...
// Append a div to the body in HTML
...
d3.csv("../../data/data.csv", function(err, healthData) {
    ...
    // Creating Scale & Axis & Domain variables
    ...
    xMin = d3.min(healthData, function(data) {
        return +data.poverty * 0.93;
    });
    xMax = d3.max(healthData, function(data) {
        return +data.poverty * 1.08;
    });
    yMin = d3.min(healthData, function(data) {
        return +data.phys_act * 0.99;
    });
    yMax = d3.max(healthData, function(data) {
        return +data.phys_act *1.03;
    });
    ...
    // Create tooltip and selecting data
    chart.call(toolTip);
...
// Append the xaxis, then display x-axis 
    chart
        .append("g")
